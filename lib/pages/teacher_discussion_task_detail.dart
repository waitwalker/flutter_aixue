...
///
/// @name TeacherDiscussionTaskDetail
/// @description 教师讨论任务 h5
/// @author lca
/// @date 2019-09-26
///
class TeacherDiscussionTaskDetail extends StatefulWidget {
  final LastTaskList task;
  TeacherDiscussionTaskDetail(this.task);
  @override
  State<StatefulWidget> createState() {
    return _TeacherDiscussionTaskDetailState();
  }
}

class _TeacherDiscussionTaskDetailState extends State<TeacherDiscussionTaskDetail> {
  LastTaskList task;
