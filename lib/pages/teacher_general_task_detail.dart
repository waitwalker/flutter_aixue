...
///
/// @name TeacherGeneralTaskDetailPage
/// @description 教师学一般任务 原生:文本,图片,视频,音频
/// @author lca
/// @date 2019-09-26
///
class TeacherGeneralTaskDetailPage extends StatefulWidget {

  final LastTaskList task;

  TeacherGeneralTaskDetailPage(this.task);

  @override
  State<StatefulWidget> createState() {
    return _TeacherGeneralTaskDetailState();
  }
}

class _TeacherGeneralTaskDetailState extends State<TeacherGeneralTaskDetailPage> {
  ...
  ///
  initData() async {
    ResponseData responseData = await DaoManager.teacherResourceTaskDetailFetch({
      "jid":"9620132",
      "schoolId":"50043",
